                      ...
                      <div class="form-row">
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputFirstName" v-model="form.salary" 
                      ...
                      <div class="form-row">
                           <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputFirstName" v-model="form.nid" 
